...
This is a command-line application which manages the conference bookings. It allows users to book tickets by providing their name, email, and the number of tickets they want to book. This application ensures that the total number of available tickets is not exceeded and provides a confirmation message for each booking.
